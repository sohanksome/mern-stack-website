...
import { Box, Heading, Text, Image, HStack, IconButton, useColorModeValue, useToast, ModalContent, ModalHeader, ModalCloseButton, ModalBody, VStack, Input, useDisclosure, Modal, ModalOverlay, ModalFooter, Button } from '@chakra-ui/react';
...
const ProductCard = ({ product }) => {
    ...
    const {deleteProducts, updateProduct} = uesProductStore()
